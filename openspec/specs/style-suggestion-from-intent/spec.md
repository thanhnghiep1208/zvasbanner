# Spec: Style Suggestion from Intent

## Purpose

Defines how campaign intent selection surfaces non-intrusive style suggestions (mood and style badges) in `StyleControls`, and how users can apply them with a single click without automatic mutation.
